...
SECTION_MAP = {
    ...
    "/api/service-teacher-customers": "服务老师",
...
FIELD_NAMES = {
    ...
    "restored_count": "退回卡次",
    "withdrawn_at": "退课办理时间",
    "withdrawn_by": "退课办理人", "withdrawn_by_id": "退课办理账号编号",
    "record_type": "活动类型",
    "cancelled_at": "恢复退课时间",
    "cancelled_by": "恢复操作人", "cancelled_by_id": "恢复操作账号编号",
    ...
    "needs": "来访需求", "receptionist": "接待人", "goal": "目标", "visit_date": "到访日期",
    ...
    "project_name": "项目名称",
    "deduction_date": "成交日期", "remaining_after": "扣卡后剩余次数", "reason": "扣卡原因",
