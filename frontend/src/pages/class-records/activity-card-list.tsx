...
<div className="space-y-3">
                        ...
                        <>
                          ...
                          <div className="px-5 pt-[12px] pb-1 space-y-1.5">
                            <div className="flex items-center gap-0.5">
                              ...
                              <span className="text-[12px] font-medium text-[#2b2f36] truncate ml-2.5 ">{courseMap[record.course_id] || record.course_name}</span>
                        ...
                        <>
                          ...
                          <div className="px-5 pt-[12px] pb-1 space-y-1.5">
                            <div className="flex items-center gap-0.5">
                              ...
                              <span className="text-[12px] font-medium text-[#2b2f36] truncate ml-2.5 ">觉醒游戏</span><span className="text-[12px] font-bold text-[#2b2f36] mx-0.5">·</span><span className="text-[12px] font-medium text-[#2b2f36]">{s.owner_name || getMemberName(s.owner_id) || "未分配"}</span>
                        ...
                        <>
                          ...
                          <div className="px-5 pt-[12px] pb-1 space-y-1.5">
                            <div className="flex items-center gap-0.5">
                              ...
                              <span className="text-[12px] font-medium text-[#2b2f36] truncate ml-2.5 ">情绪释放</span><span className="text-[12px] font-bold text-[#2b2f36] mx-0.5">·</span><span className="text-[12px] font-medium text-[#2b2f36]">{s.owner_name || getMemberName(s.owner_id) || "未分配"}</span>
                              {s.achiever_name && <span className="inline-block ml-1 px-1.5 py-0.5 rounded text-[10px] font-normal bg-[#fafbfc] text-[#787f88]">成就君：{s.achiever_name}</span>}
                              {getRoomLabel(s.space_id, s.room_id, spaces) && <span className="inline-block ml-1 px-1.5 py-0.5 rounded text-[10px] font-normal bg-[#fafbfc] text-[#787f88]">{getRoomLabel(s.space_id, s.room_id, spaces)}</span>}
                              {s.activity_mode && s.activity_mode !== "线下" && <span className="inline-block ml-1 px-1.5 py-0.5 rounded text-[10px] font-normal bg-[#fafbfc] text-[#787f88]">线上</span>}
                ...
                if (ur.type === "eks") {
                  const s = ur.data
                  let eksNames: string[] = []
                  let eksDetails: { name: string; count: number }[] = []
                  try {
                    const items = JSON.parse(s.description || "[]")
                    if (Array.isArray(items)) {
                      eksNames = items.map((d: any) => d.name).filter(Boolean)
                      eksDetails = items.filter((d: any) => d.name).map((d: any) => ({ name: d.name, count: d.count ?? 1 }))
                    }
                  } catch { /* empty */ }
                  return (
                    <div
                        ...
                        <>
                          ...
                          <div className="px-5 pt-[12px] pb-1 space-y-1.5">
                            <div className="flex items-center gap-0.5">
                              ...
                              <span className="text-[12px] font-medium text-[#2b2f36] truncate ml-2.5">{s.course_name}</span>
                        ...
                        <>
                          ...
                          <div className="px-5 pt-[12px] pb-1 space-y-1.5">
                            <div className="flex items-center gap-0.5">
                              ...
                              <span className="text-[12px] font-medium text-[#2b2f36] truncate ml-2.5 ">OH卡梳理</span><span className="text-[12px] font-bold text-[#2b2f36] mx-0.5">·</span><span className="text-[12px] font-medium text-[#2b2f36]">{s.owner_name || getMemberName(s.owner_id) || "未分配"}</span>
                              {s.achiever_name && <span className="inline-block ml-1 px-1.5 py-0.5 rounded text-[10px] font-normal bg-[#fafbfc] text-[#787f88]">成就君：{s.achiever_name}</span>}
                              {getRoomLabel(s.space_id, s.room_id, spaces) && <span className="inline-block ml-1 px-1.5 py-0.5 rounded text-[10px] font-normal bg-[#fafbfc] text-[#787f88]">{getRoomLabel(s.space_id, s.room_id, spaces)}</span>}
                              {s.activity_mode && s.activity_mode !== "线下" && <span className="inline-block ml-1 px-1.5 py-0.5 rounded text-[10px] font-normal bg-[#fafbfc] text-[#787f88]">线上</span>}
