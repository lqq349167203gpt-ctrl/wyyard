        ...
        <div className="min-w-[1688px]">
          ...
          <thead>
            <tr className="bg-[#fafbfc] text-[#8f959e]">
              ...
              <th className="px-1.5 py-2 text-center font-normal w-[62px] sticky right-0 bg-[#fafbfc] z-10 relative before:content-[''] before:absolute before:top-0 before:bottom-0 before:-left-2 before:w-2 before:[background:linear-gradient(to_left,rgba(0,0,0,0.02),transparent)]">操作</th>
            </tr>
          </thead>
