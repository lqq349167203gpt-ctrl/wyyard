...
App({
  globalData: {
    ...
    currentUser: null,
    permissions: [],
    editPermissions: { customers: 'all', visits: 'own', activities: 'own', activity_teachers: 'own', activity_participants: 'all', activity_lock: false, payments: 'all' },
  ...
  onLaunch() {
    if (this.globalData.devMode) {
      ...
      if (token && user) {
        ...
        this.globalData.editPermissions = wx.getStorageSync('userEditPermissions') || { customers: 'all', visits: 'own', activities: 'own', activity_teachers: 'own', activity_participants: 'all', activity_lock: false, payments: 'all' }
      }
  ...
  async refreshPermissions() {
    ...
    const editPermissions = (result && result.edit_permissions) || { customers: 'all', visits: 'own', activities: 'own', activity_teachers: 'own', activity_participants: 'all', activity_lock: false, payments: 'all' }
  ...
  async _devAutoLogin() {
    try {
      ...
      this.globalData.editPermissions = data.edit_permissions || { customers: 'all', visits: 'own', activities: 'own', activity_teachers: 'own', activity_participants: 'all', activity_lock: false, payments: 'all' }
  ...
  logout() {
    ...
    this.globalData.editPermissions = { customers: 'all', visits: 'own', activities: 'own', activity_teachers: 'own', activity_participants: 'all', activity_lock: false, payments: 'all' }
    wx.reLaunch({ url: '/pages/login/index' })
  },
})
